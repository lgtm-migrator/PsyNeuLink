...
from psyneulink.core.scheduling.time import _time_scale_mappings
...
def _modify_docstring(docstring):
    ...
    for ts_name in _time_scale_mappings:
        scheduler_ts_name = _time_scale_mappings[ts_name].name
        new_docstring = re.sub(f'{scheduler_ts_name}', f'{ts_name}', new_docstring)

    return new_docstring


__doc__ = _modify_docstring(graph_scheduler.condition.__doc__)
